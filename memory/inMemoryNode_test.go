...
func TestIsLeaf(t *testing.T) {
	...
	n := NewNodeWithChildren([]int64{1, 2, 4, 5}, []*InMemoryNode{child1, child2})
	if n.isLeaf() {
...
func TestHasOverFlown(t *testing.T) {
	...
	child1 := NewLeafNode([]int64{10, 11})
	child2 := NewLeafNode([]int64{13, 14})
	n = NewNodeWithChildren([]int64{1, 2, 3, 4, 5, 6}, []*InMemoryNode{child1, child2})
	if !n.hasOverFlown() {
		t.Error("Should return true as node has 6 elements", n)
	}
...
func TestSplitNonLeafNode(t *testing.T) {
	...
	n := NewNodeWithChildren([]int64{15, 35, 45, 55, 65, 75}, []*InMemoryNode{child1, child2, child3,
...
func TestAddPoppedupElement(t *testing.T) {
	...
	parentNode := NewNodeWithChildren([]int64{500}, []*InMemoryNode{child1OfParent, child2OfParent})
